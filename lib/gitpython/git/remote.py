...
class FetchInfo(object):
	...
	def _from_line(cls, repo, line, fetch_line):
		...
		* means birth of new branch or tag
        ...
        # workaround to fix incorrectly matched branch names
 		#if not local_remote_ref in remote_local_ref:
 			#remote_local_ref = re.sub('/.+', '/%s' % local_remote_ref, remote_local_ref)
